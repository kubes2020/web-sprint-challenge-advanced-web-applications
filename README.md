...
- Tokens are used to verify that the client is who they say they are, and then gives access to content via private routes.

2. What steps can you take in your web apps to keep your data secure?

- Use tokens to verify users, don't store authorization codes in local storage.

3. Describe how web servers work.

- Web servers are computers with web server software. With a request from a client and a URL, the server will send back the data in a response to the ip address that made the request.
